import {Proposals} from "@thirdweb-dev/sdk";
...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x6F8816B8979877801b64A4342E9477833e9224F9", "edition-drop").contract;

  const token = useContract("0x5A38aEDD0A024673E3A6678bf25B13F76B4aaD6b","token").contract;

  const vote = useContract("0x391da075D0147F990030dD99c094006686691A09","vote").contract;

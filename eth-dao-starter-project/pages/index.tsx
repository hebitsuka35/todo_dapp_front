...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x0b7C76DBaEAc6D46ECDA7bFEaA0f11bCb88e86aB", "edition-drop").contract;

  // トークンコントラクトの初期化
  const token = useContract("0x9f97394D3DAec9E4622dd3fA501d0C80416142bb", "token").contract;

  // 投票コントラクトの初期化
  const vote = useContract("0xbaE5b2dfD6914a9f35902E09ee2B44bdc9be609D", "vote").contract;
